...
lazy val frontend = (project in file("frontend"))
  ...
  .settings(
    ...
    dockerAlias           := DockerAlias.apply(dockerRepository.value, None, "tyrian-flowbite-quickstart/frontend", dockerAlias.value.tag),
...
lazy val backend = (project in file("backend"))
  ...
  .settings(
    ...
    dockerRepository   := Some(DockerSettings.repository),
    dockerAlias        := DockerAlias.apply(dockerRepository.value, None, "tyrian-flowbite-quickstart/backend", dockerAlias.value.tag),
    DockerSettings.x86ArchSetting
  )
...
lazy val common = (crossProject(JVMPlatform, JSPlatform)
  ...
  .settings(
    ...
    buildInfoPackage := "com.example.common"
  )
